...
use non_membership_proofs::scanner::AccountNotesVisitor;
use non_membership_proofs::user_nullifiers::NoteNullifier as _;
use non_membership_proofs::{Nullifier, ViewingKeys};
...
impl PoolProcessor for SaplingPool {
    ...
    fn collect_notes(
        ...
        let hiding_factor: non_membership_proofs::user_nullifiers::SaplingHidingFactor =
...
impl PoolProcessor for OrchardPool {
    ...
    fn collect_notes(
        ...
        let hiding_factor: non_membership_proofs::user_nullifiers::OrchardHidingFactor =
